...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(router, userService, activatedRoute) {
        this.router = router;
    ...
    DashboardComponent.prototype.goToAddUser = function () {
        this.router.navigateByUrl('dashboard/user-create');
    };
    DashboardComponent.prototype.goToUserPreview = function () {
    ...
    DashboardComponent.prototype.isRoute = function (url) {
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.goToMyProfile = function () {
...
var UserModComponent = /** @class */ (function () {
    function UserModComponent(modalService, logger, userService, activatedRoute) {
    ...
    UserModComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.user = new _core_models__WEBPACK_IMPORTED_MODULE_4__["User"]();
        this.userId = this.activatedRoute.snapshot.paramMap.get('id');
        if (this.userId) {
            this.userService.getUserById(this.userId).subscribe(function (user) {
                _this.user = user;
            });
        }
    };
    UserModComponent.prototype.onGeneratePasswordClick = function () {
        var _this = this;
        var modalRef = this.modalService.open(_shared_components__WEBPACK_IMPORTED_MODULE_3__["GeneratePasswordPopupComponent"]);
        modalRef.result
            .then(function (res) {
            if (!res) {
                return;
            }
            _this.user.password = res;
            _this.user.repeatPassword = res;
        })
            .catch(function (err) { return console.error(err); });
    };
    UserModComponent.prototype.onCreateUserClick = function (form) {
        if (form.invalid) {
            return;
        }
    ...
    UserModComponent.prototype.onEditUserClick = function (form) {
        if (form.invalid) {
            return;
        }
        this.logger.debug(this.user);
    ...
    UserModComponent.prototype.onCheckMail = function () {
        var _this = this;
        if (this.userId) {
            return;
        }
        this.userService.checkMail(this.user.mail).subscribe(function (valid) {
            _this.mailValid = valid;
            _this.check = true;
        });
    };
    UserModComponent.prototype.onSubmit = function (form) {
        if (!this.userId) {
            this.onCreateUserClick(form);
        }
        this.onEditUserClick(form);
    };
    UserModComponent.ctorParameters = function () { return [
...
var UserPreviewComponent = /** @class */ (function () {
    function UserPreviewComponent(activatedRoute, logger, userService) {
        this.activatedRoute = activatedRoute;
        this.logger = logger;
        this.userService = userService;
        this.password = '';
    ...
    UserPreviewComponent.prototype.ngOnInit = function () {
        ...
        this.userService.getUserById(this.userId)
            .subscribe(function (res) {
            _this.logger.debug(res);
            _this.user = res;
        });
    };
    UserPreviewComponent.prototype.onCheckPassword = function () {
        var _this = this;
    ...
    UserPreviewComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
...
var UsersComponent = /** @class */ (function () {
    function UsersComponent(modalService, userService, logger, router) {
        this.modalService = modalService;
        this.userService = userService;
        this.logger = logger;
        this.router = router;
    ...
    UsersComponent.prototype.ngOnInit = function () {
        ...
        this.userService.getUsers().subscribe(function (users) {
            _this.logger.debug(users);
            _this.users = users;
        });
    };
    UsersComponent.prototype.onRemoveClick = function (id) {
        var _this = this;
        var modalRef = this.modalService.open(_shared_components__WEBPACK_IMPORTED_MODULE_3__["ConfirmPopupComponent"]);
        modalRef.result.then(function (res) {
            if (!res) {
                return;
            }
            _this.userService.deleteUser(id).subscribe(function () { }, function (err) { return _this.logger.error(err); });
        });
    };
    UsersComponent.prototype.onEditClick = function (id) {
        this.router.navigateByUrl("dashboard/user-edit/" + id);
    };
    UsersComponent.prototype.onPreviewClick = function (id) {
