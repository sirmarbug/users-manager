...
class User {
    constructor(id = '', firstName = '', lastName = '', city = '', country = '', mail = '', role = _role__WEBPACK_IMPORTED_MODULE_0__["Role"].USER, password = '', repeatPassword = '') {
        this.id = id;
...
let UserService = class UserService {
    ...
    login(mail, password) {
        return this.db.collection('users', ref => ref.where('mail', '==', mail).where('password', '==', password))
            .valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((_) => {
            if (_.length < 1) {
                return false;
            }
    ...
    checkMail(mail) {
        return this.db.collection('users', ref => ref.where('mail', '==', mail)).valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((_) => {
            if (_.length < 1) {
                return true;
            }
            return false;
    ...
    getUserById(id) {
        return this.userCollection.doc(id).valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((res) => res));
    }
    addUser(user) {
        const newUser = Object.assign({}, user);
        delete newUser.id;
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["from"])(this.userCollection.add(newUser))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(_ => {
            _.update('id', _.id);
...
class PasswordGenerator {
    ...
    static withoutRepeating(length) {
        let result = '';
...
let GeneratePasswordPopupComponent = class GeneratePasswordPopupComponent {
    constructor(activeModal) {
        this.activeModal = activeModal;
...
GeneratePasswordPopupComponent.ctorParameters = () => [
    { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbActiveModal"] }
];
...
const components = [_confirm_popup_confirm_popup_component__WEBPACK_IMPORTED_MODULE_0__["ConfirmPopupComponent"], _generate_password_popup_generate_password_popup_component__WEBPACK_IMPORTED_MODULE_1__["GeneratePasswordPopupComponent"]];
...
//# sourceMappingURL=default~views-auth-auth-module~views-dashboard-dashboard-module-es2015.js.map