...
const routes = [
    {
        path: 'auth',
        loadChildren: () => Promise.all(/*! import() | views-auth-auth-module */[__webpack_require__.e("default~views-auth-auth-module~views-dashboard-dashboard-module"), __webpack_require__.e("views-auth-auth-module")]).then(__webpack_require__.bind(null, /*! ./views/auth/auth.module */ "./src/app/views/auth/auth.module.ts")).then(m => m.AuthModule)
    },
    {
        path: 'dashboard',
        loadChildren: () => Promise.all(/*! import() | views-dashboard-dashboard-module */[__webpack_require__.e("default~views-auth-auth-module~views-dashboard-dashboard-module"), __webpack_require__.e("views-dashboard-dashboard-module")]).then(__webpack_require__.bind(null, /*! ./views/dashboard/dashboard.module */ "./src/app/views/dashboard/dashboard.module.ts")).then(m => m.DashboardModule)
    },
    {
        path: '',
        redirectTo: 'auth',
